...
let count:number = 0
let winner:number = 1
let player1Moves:number = 1
let player2Moves:number = 1
...
let counter:ICounter[] = [{ Player: 'Player 1', PlayerMoves: 1, PlayerPosition: 1, Dice: 0 },
                ...
                gameData.forEach(element => {
                    if (element.id === player1Position + randomNumberGenerator) {
                        if (element.to !== '') {
                            ...
                            setPlayer1Position(Number(element.to))
                        } else {
                ...
                gameData.forEach(element => {
                    if (element.id === player2Position + randomNumberGenerator) {
                        if (element.to !== '') {
                            ...
                            setPlayer2Position(Number(element.to))
                        } else {
        ...
        <div >
            <div className='window'>
                ...
                <div className='GridBox'>
                    {gameData.map(n => <Props value={n.id} data={n.players} icon={n.icon} key={n.id}/>)}
                </div>
            </div>
        </div>
    )
